...
export const getColumns = ({ refetch }: GetColumnsProps): ColumnDef<PSQ>[] => {
  return [
    {
      accessorKey: 'name',
      header: ({ column }) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <CreateUpdateDialog psq={psq} refetch={refetch} />
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <DeleteDialog psq={psq} refetch={refetch} />
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )

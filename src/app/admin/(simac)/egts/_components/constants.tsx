...
export const getColumns = ({ refetch }: GetColumnsProps): ColumnDef<EGT>[] => {
  return [
    {
      accessorKey: 'name',
      header: ({ column }) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <CreateUpdateDialog egt={egt} refetch={refetch} />
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <DeleteDialog egt={egt} refetch={refetch} />
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )

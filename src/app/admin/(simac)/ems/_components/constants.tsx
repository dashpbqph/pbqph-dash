...
export const getColumns = ({ refetch }: GetColumnsProps): ColumnDef<EM>[] => {
  return [
    {
      accessorKey: 'name',
      header: ({ column }) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <CreateUpdateDialog em={em} refetch={refetch} />
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <DeleteDialog em={em} refetch={refetch} />
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )

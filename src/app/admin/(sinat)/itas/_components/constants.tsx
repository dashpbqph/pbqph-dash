...
export const getColumns = ({ refetch }: GetColumnsProps): ColumnDef<ITA>[] => {
  return [
    {
      accessorKey: 'name',
      header: ({ column }) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <CreateUpdateDialog ita={ita} refetch={refetch} />
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <DeleteDialog ita={ita} refetch={refetch} />
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )

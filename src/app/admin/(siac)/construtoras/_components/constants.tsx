...
export const getColumns = ({ refetch }: GetColumnsProps): ColumnDef<Company>[] => {
  return [
    {
      accessorKey: 'name',
      header: ({ column }) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <CreateUpdateDialog company={company} refetch={refetch} />
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <DeleteDialog company={company} refetch={refetch} />
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )

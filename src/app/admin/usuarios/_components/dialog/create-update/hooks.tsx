...
export async function uploadImage({ username, imageFile }: UploadImageProps): Promise<void> {
...
export function useImageUpload({ avatarSeed, userCreateUpdateForm }: ImageUploadProps) {
...
export function usePasswordManagement({ userCreateUpdateForm }: PasswordManagementProps) {
  ...
  const handleCopyPassword = () => {
    ...
    navigator.clipboard.writeText((userCreateUpdateForm.getValues('password') || '') as string)

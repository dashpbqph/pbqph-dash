...
export function useProjectFormSubmit({ isEditing, onClose, project }: ProjectFormSubmitProps) {
      ...
      toast({
        ...
        description: (
          <div className="mt-1 rounded-md">
            <span>
              A obra <strong>{values.name}</strong> foi {isEditing ? 'atualizada' : 'cadastrada'}{' '}
              com sucesso.
            </span>
          </div>
        ),

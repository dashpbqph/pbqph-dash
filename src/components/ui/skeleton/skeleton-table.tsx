...
export default function SkeletonTable({ hasCreateButton = false }: SkeletonTableProps) {
  return (
    <div className="flex h-full w-full flex-col gap-4">
      ...
      >
        ...
        {hasCreateButton && <div className="w-[140px] animate-pulse rounded-md bg-gray-200" />}
      </div>

...
import DeleteUserDialogButton from './UserDeleteDialog'
import ResetUserPasswordDialogButton from './UserResetPasswordDialog'

type User = Awaited<ReturnType<typeof server.user.getAll.query>>[number]
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                <ResetUserPasswordDialogButton username={username} />
              </DropdownMenuItem>
              <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
